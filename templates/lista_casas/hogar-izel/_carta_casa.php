        ...
        <div class="property-card-header image-box">
            ...
            <a href="<?php echo $generales->url_base; ?>hogares/hogar-izel.php" class="property-card-hover">
                <div class="property-card-tags" >
                    <span style="background: #0000cc" class="label label-default label-tag-primary">Renovación</span>
                </div>
...
<script>
    function getlinkOrquidea() {
        ...
        aux.setAttribute("value","<?php echo $generales->url_base; ?>hogares/hogar-izel.php");
