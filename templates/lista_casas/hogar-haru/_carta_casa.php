...
<div class="col-md-4 col-sm-6">
    <div class="property-card card">
        <div class="property-card-header image-box">
            ...
            <img src="<?php echo $generales->url_base;?>assets/img/venta_casas/hogar_haru/1Fachada/img1.jpg" alt="" class="" />

            <!--Casa destacada en caso de serlo-->
            <!--<div class="budget"><i class="fa fa-star"></i></div>-->
            <a href="<?php echo $generales->url_base; ?>hogares/hogar-haru.php" class="property-card-hover">
        ...
        <?php include $generales->path_base.'templates/lista_casas/hogar-haru/_carta_casa_detalles.php' ?>
    </div>
</div>
<script>
    function getlinkOrquidea() {
        var aux = document.createElement("input");
        aux.setAttribute("value","<?php echo $generales->url_base; ?>hogares/hogar-haru.php");
