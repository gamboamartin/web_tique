...
<div class="col-md-4 col-sm-6">
    <div class="property-card card">
        <div class="property-card-header image-box">
            ...
            <img src="<?php echo $generales->url_base;?>./assets/img/venta_casas/hogar_araucaria/1Fachada/fachada_1.jpg" alt="" class="" />

            <!--Casa destacada en caso de serlo-->
            <!--<div class="budget"><i class="fa fa-star"></i></div>-->
            <a href="<?php echo $generales->url_base; ?>hogares/hogar-araucaria.php" class="property-card-hover">
...
<script>
    function getlinkOrquidea() {
        ...
        aux.setAttribute("value","<?php echo $generales->url_base; ?>hogares/hogar-xadani.php");
