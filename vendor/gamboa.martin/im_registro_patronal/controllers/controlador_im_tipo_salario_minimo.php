...
class controlador_im_tipo_salario_minimo extends system {

    public function __construct(PDO $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass()){
        $modelo = new im_tipo_salario_minimo(link: $link);
        $html_ = new im_tipo_salario_minimo_html(html: $html);
    ...
    public function alta(bool $header, bool $ws = false): array|string
    {
        ...
        $inputs = (new im_tipo_salario_minimo_html(html: $this->html_base))->genera_inputs_alta(controler: $this,
          link: $this->link);
        if(errores::$error){
    ...
    private function base(stdClass $params = new stdClass()): array|stdClass
    {
        ...
        $inputs = (new im_tipo_salario_minimo_html(html: $this->html_base))->inputs_im_tipo_salario_minimo(
