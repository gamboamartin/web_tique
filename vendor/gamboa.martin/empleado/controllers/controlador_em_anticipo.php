...
class controlador_em_anticipo extends system {
    ...
    public function alta(bool $header, bool $ws = false): array|string
    {
        ...
        $inputs = (new em_anticipo_html(html: $this->html_base))->genera_inputs_alta(
            controler: $this, modelo: $this->modelo, link: $this->link,keys_selects: $this->keys_selects);
        if(errores::$error){
    ...
    private function base(stdClass $params = new stdClass()): array|stdClass
    {
        ...
        $inputs = (new em_anticipo_html(html: $this->html_base))->inputs_em_anticipo(
