...
class controlador_cat_sat_tipo_impuesto extends system {
    ...
    public function alta(bool $header, bool $ws = false): array|string
    {
        ...
        $inputs = (new cat_sat_tipo_impuesto_html(html: $this->html_base))->genera_inputs_alta(controler: $this, link: $this->link);
        if(errores::$error){
                             ...
                             bool $muestra_btn = true): array|string
    {
        ...
        $inputs = (new cat_sat_tipo_impuesto_html(html: $this->html_base))->inputs_cat_sat_tipo_impuesto(controlador: $this);
        if(errores::$error){
