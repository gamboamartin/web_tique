...
class controlador_bn_banco extends system {
    ...
    public function alta(bool $header, bool $ws = false): array|string
    {
        ...
        $inputs = (new bn_banco_html(html: $this->html_base))->genera_inputs_alta(controler: $this, link: $this->link);
        if(errores::$error){
    ...
    private function base(stdClass $params = new stdClass()): array|stdClass
    {
        ...
        $inputs = (new bn_banco_html(html: $this->html_base))->inputs_bn_banco (
