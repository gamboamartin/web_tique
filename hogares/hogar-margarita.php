...
$descripcion_twitter = 'Hogar Margarita se ubica se encuentra ubicada en El Fraccionamiento Los Alcatraces del municipio de Tlajomulco de Zúñiga, al sur del Área Metropolitana de Guadalajara, ideal para el bienestar de su familia por su tranquilidad y comodidad par poder vivir, se caracteriza por la tranquilidad que existe, Hogar Margarita cuenta con fácil acceso a escuelas, parques de recreación familiar y centros comerciales.

Hogar Margarita es una Casa Habitación de dos niveles que se distribuye de la siguiente manera, en la planta baja tenemos su Sala, Comedor, Cocina, patio trasero de servicio y en la planta alta 2 recámaras, 1 baño cuenta con su propia cochera para un auto.
...
<head>
    ...
    <meta property='twitter:image' content="<?php echo $generales->url_base; ?>assets/img/venta_casas/hogar_margarita/1Fachada/fachada_1.jpg"/>
    <meta property="og:description" content="Hogar Margarita se ubica se encuentra ubicada en El Fraccionamiento Los Alcatraces del municipio de Tlajomulco de Zúñiga, al sur del Área Metropolitana de Guadalajara, ideal para el bienestar de su familia por su tranquilidad y comodidad par poder vivir, se caracteriza por la tranquilidad que existe, Hogar Margarita cuenta con fácil acceso a escuelas, parques de recreación familiar y centros comerciales." />
...
<body class="">
<img src="<?php echo $generales->url_base; ?>assets/img/venta_casas/hogar_margarita/1Fachada/fachada_1.jpg" hidden>
<div id="fb-root"></div>
