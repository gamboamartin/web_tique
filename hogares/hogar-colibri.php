...
<head>
    ...
    <meta property="og:description" content="Hogar Colibrí es un bonito departamento ubicado al Norte de Zapopan, Jalisco, en la Colonia Constitución, Hogar Colibrí se encuentra situado en una colonia tranquila del municipio de Zapopan,  ideal por su espacio acogedor y armonioso para vivir felizmente y en un entorno amigable, gracias a su excelente ubicación, cuenta con todos  los servicios indispensables a la mano para una buena calidad de vida, por su fácil y rápido acceso a hospitales, escuelas, tiendas de autoservicio, CUCEA, Estación del tren ligero, Mi Macro Periférico." />
...
<body class="">
<img src="<?php echo $generales->url_base; ?>assets/img/venta_casas/hogar_colibri/3Cocina/cocina_1.jpg" hidden>
<div id="fb-root"></div>
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="widget widget-box box-container widget-property">
                        ...
                        <?php include $generales->path_base.'templates/descripcion/hogar-colibri/_descripcion_hogar_colibri.php' ?>
                    </div> <!-- /. widget-body -->
                    <?php include $generales->path_base.'templates/ubicaciones/_ubicacion_general.php' ?>
                    <?php include $generales->path_base.'templates/galeria/hogar-colibri/_galeria_hogar.php' ?>
