...
$descripcion_twitter = 'Hogar Glicinia es una maravillosa casa con terreno excedente ubicada en Fracc. Santa Fe, Cluster 28 del municipio de Tlajomulco de Zúñiga, al sur del Área Metropolitana de Guadalajara, ideal para el bienestar de su familia por su tranquilidad y comodidad par poder vivir, para disfrutar de la armonía en donde se localiza la vivienda, Hogar Glicinia cuenta con fácil acceso a escuelas, parques de recreación familiar y centros comerciales.
';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <meta property='twitter:image' content="<?php echo $generales->url_base; ?>assets/img/venta_casas/hogar_glicinia/1Fachada/fachada_1.jpg"/>
    <meta property="og:description" content="Hogar Glicinia es una maravillosa casa con terreno excedente ubicada en Fracc. Santa Fe, Cluster 28 del municipio de Tlajomulco de Zúñiga, al sur del Área Metropolitana de Guadalajara, ideal para el bienestar de su familia por su tranquilidad y comodidad par poder vivir, para disfrutar de la armonía en donde se localiza la vivienda, Hogar Glicinia cuenta con fácil acceso a escuelas, parques de recreación familiar y centros comerciales." />
...
<body class="">
<img src="<?php echo $generales->url_base; ?>assets/img/venta_casas/hogar_glicinia/1Fachada/fachada_1.jpg" hidden>
<div id="fb-root"></div>
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="widget widget-box box-container widget-property">
                        <?php include $generales->path_base.'templates/sliders/hogar_glicinia/_slider_hogar_glicinia.php' ?>
                        <?php include $generales->path_base.'templates/descripcion/hogar-glicinia/_descripcion_hogar_glicinia.php' ?>
                    </div> <!-- /. widget-body -->
                    <?php include $generales->path_base.'templates/ubicaciones/_ubicacion_general.php' ?>
                    <?php include $generales->path_base.'templates/galeria/hogar-glicinia/_galeria_hogar.php' ?>
